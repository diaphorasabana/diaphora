...
%\setmainfont[Ligatures={Common,TeX}]{\fuenteprincipal}
...
Semestre 2018-1. Número 1.

Diáphora es una revista de publicación académica con frecuencia
...
\begin{itemize}
\item
  \href{mailto:diaphora@unisabana.edu.co}{\nolinkurl{diaphora@unisabana.edu.co}}
\end{itemize}
...
Tatiana Gomez Sanchez & 4:00 4:30 & ¿Es posible escuchar de nuevo y en
vivo una misma improvisación musical?\tabularnewline
...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Responder la pregunta ¿Por qué las leyes son necesariamente
  vagas? }
\end{enumerate}
...
\autor{Pablo Rivas Robledo\footnote{Estudiante de séptimo semestre de
  ...
  Correo
  \href{mailto:pabloriro@unisabana.edu.co}{\nolinkurl{pabloriro@unisabana.edu.co}}}}

\textbf{Dos niveles de la paradoja}\footnote{Al final del escrito consta
...
contradice la regla que le da validez, por ende, no esta regla no es
...
\textbf{El tercer nivel de la paradoja: Sobre la auto-reforma o de la
reforma de los mecanismos de reforma constitucional}
...
jurídicas\footnote{Esto no implica que no sean modificables por vías no
  jurídicas, si un gobierno X impone su OJ sobre un gobierno Y, las
  normas jurídicas que pertenecían al OJ de Y se eliminaron, y no por un
  medio jurídico. Agradezco a Isabel Maldonado, quien me hizo dar cuenta
...
constitucionales de cualquier ordenamiento jurídico OJ suponen un
problema de interés filosófico. Tal como sucedía en la relación entre M
y H, en algunos OJ existe una norma fundamental. Me interesan aquellos
en los que sí. La norma fundamental en estos sistemas normalmente es la
...
Legislativo 01 de 2016 (AL) introdujo un nuevo mecanismo de reforma
...
la Constitución,\footnote{Esto es, sólo el O\textsubscript{0} mediante
  ...
  órgano ni un procedimiento más rígidos en el OJ (ꓱ!x ꓱ!y ((Ox \& Py)
  \& ¬ꓱz ¬ꓱw (Ezx v Ewy))), estos límites se conocen como los límites
  normativo-institucionales del OJ (Pactet \& Melin-Soucramanien, 2011,
  p. 66). La Constitución colombiana es un ejemplo de una Constitución
  rígida.}. Preguntarse si el artículo 88 de N\textsubscript{0} es
...
de las constituciones rígidas) reformar el contenido del artículo 88.
...
pertenece a un OJ en virtud de que una norma
...
reformable, algo imposible toda norma de un OJ es reformable, pero por
el ejercicio anterior sabemos que no hay un mecanismo dentro del OJ.
...
Supóngase que se introduce una ley de reforma constitucional LR tal que:

\begin{quote}
Art. 1 LR: Queda derogado el artículo 88 de N\textsubscript{0}.

Art. 2 LR: El artículo 88 de N\textsubscript{0} quedará así:
...
¿Puede LR derogar el artículo 88 de N\textsubscript{0} en tanto el
artículo 88 de N\textsubscript{0} le confiere validez a LR? Moreso
piensa que no, debido a que la derogación del artículo 88 entra en
contradicción con lo que denomina el principio dinámico del Derecho
(PDD) (Moreso, 1991, pp. 212--213). La formulación de dicho principio es
la siguiente:

\begin{quote}
PDD: Si una LR ha sido creada en el momento \emph{t} y existe una norma
válida en el momento \emph{t} que autoriza la creación de LR en \emph{t}
(en este caso el artículo 88 de N\textsubscript{0}), entonces LR es
válida en \emph{t}. Pero si la norma que autoriza LR en \emph{t} es
derogada por LR en el momento \emph{t} (siendo esta válida en el momento
...
\textbf{La solución a la paradoja}

Sin embargo, existe una solución a esta paradoja que no implica sacar a
N\textsubscript{0.88} del OJ. Es la siguiente. En el marco de las
...
constituciones rígidas. Como se expuso, si se tiene que ꓱ!x ꓱ!y ((Ox \&
Py) \& ¬ꓱz \protect\hypertarget{_Hlk495321050}{}{}¬ꓱw (Ezx v Ewy))
...
límites normativo-institucionales de N\textsubscript{0}.
...
Colombia, a partir de AL, se pasó de N\textsubscript{0} a
N\textsubscript{0}'.
...
darme cuenta los sistemas de reglas se pueden clasificar en dos grupos
...
OJ: & Ordenamiento jurídico\tabularnewline
LR: & Ley de reforma constitucional\tabularnewline
PDD: & Principio dinámico del Derecho\tabularnewline
AL: & Acto Legislativo 01 de 2016\tabularnewline
...
\item
  \textbf{La experiencia artística caracteriza lo humano.}
\end{enumerate}
...
\def\labelenumi{\Roman{enumi}.}
\item
  \textbf{La explicación física no logra abarcar la riqueza de la
...
\def\labelenumi{\Roman{enumi}.}
\item
  \protect\hypertarget{_Hlk507102126}{}{}\textbf{El fin del proyecto
...
\chapter{\texorpdfstring{\textbf{?`Es posible escuchar de nuevo y en vivo
una misma improvisación
musical?}}{?`Es posible escuchar de nuevo y en vivo una misma improvisación musical?}}\label{es-posible-escuchar-de-nuevo-y-en-vivo-una-misma-improvisaciuxf3n-musical}

\autor{Tatiana Gómez Sánchez}
...
Así, el orden que seguiré en esta ponencia será el siguiente: (1)
caracterización de la improvisación musical, (2) la distinción tipo/caso
como herramienta de la ontología musical para caracterizar una obra y su
relación con el performance, (3) dos sentidos en los que se puede
entender que una pieza musical sea la \emph{misma}, (4) concebir la
improvisación como una obra musical a partir de la distinción tipo/caso,
y (5) respuesta a la pregunta y la pertinencia del tema en el debate de
la ontología musical.

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Improvisación musical}
\end{enumerate}
...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Distinción tipo/caso y el estatus ontológico de una obra
  musical}
\end{enumerate}
...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Distinción \emph{mismo\textsubscript{1}} y
...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{La improvisación como obra musical a partir de la distinción
  tipo caso}
\end{enumerate}
...
\textbf{Conclusión -- Ontología musical}
...
formuladas como bicondicional: `∀\textsubscript{x} F\textsubscript{x} ↔
